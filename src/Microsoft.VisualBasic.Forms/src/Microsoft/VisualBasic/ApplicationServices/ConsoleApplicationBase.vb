...
Namespace Microsoft.VisualBasic.ApplicationServices
    ...
    Public Class ConsoleApplicationBase : Inherits ApplicationBase
        ...
        ''' </summary>
        ''' <remarks>
        '''  We have to have a parameterless constructor because the platform specific Application
        '''  object derives from this one and it doesn't define a constructor. The partial class generated by the
        '''  designer defines the constructor in order to configure the application.
        ''' </remarks>
        Public Sub New()
            MyBase.New()
        End Sub
